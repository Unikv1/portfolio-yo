...
CSRF_TRUSTED_ORIGINS = ['https://facundo-duenas.fly.dev']
...
AWS_S3_REGION_NAME = os.getenv('AWS_REGION', 'sa-east-1')
AWS_ENDPOINT_URL_S3 = 'https://fly.storage.tigris.dev'

AWS_S3_CUSTOM_DOMAIN = f"{AWS_STORAGE_BUCKET_NAME}.{AWS_ENDPOINT_URL_S3.split('https://')[1]}"
...
# CKEditor settings remain the same
customColorPalette = [
    {
        'color': 'hsl(4, 90%, 58%)',
        'label': 'Red'
